...
public class CurvySplineBase : MonoBehaviour
{
    ...
    /// <param name="tf"></param>
    /// <returns></returns>
    public virtual CurvySplineSegment TFToSegment(float tf) { return null; }
    /// <summary>
    ...
    public virtual CurvySplineSegment TFToSegment(float tf, out float localF) { localF = 0; return null; }
    /// <summary>
    ...
    /// </summary>
    /// <param name="angle">minimum angle in degrees</param>
